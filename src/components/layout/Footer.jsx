    ...
    <footer className="bg-secondary pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-light font-semibold text-lg mb-4">Quick Links</h3>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-light font-semibold text-lg mb-4">Customer Service</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-light font-semibold text-lg mb-4">Newsletter</h3>
            <p className="text-gray-400 mb-4">
            ...
            <form className="flex">
              <input
                ...
                className="bg-gray-800 text-light px-4 py-2 rounded-l-md w-full focus:outline-none focus:ring-1 focus:ring-primary"
              />
              <button
                type="submit"
                className="bg-primary text-black px-4 py-2 rounded-r-md font-medium hover:bg-opacity-90 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6">
          <p className="text-gray-400 text-center">
            &copy; {currentYear} CLUB. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
